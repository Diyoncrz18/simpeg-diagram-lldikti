...
| 5 | P1 | **Data Master masih Blade statis** — route closure `routes/web.php:191-194`, array hardcoded, tombol Simpan = `closeModal()`, tanpa form/CSRF; belum ada CRUD reference table maupun UI channel notifikasi | Task tracker #22 (Issue #46, US-8.5) — keputusan K-1 (hybrid `is_active`) sudah tersedia |
...
| ❌ Data Master, Hari Libur web, Pengaturan Sistem, Dashboard, RBAC, preview laporan, modal custom, PDF L1/L3 | ❌ Semua masih berlaku (lihat tabel di atas) |
